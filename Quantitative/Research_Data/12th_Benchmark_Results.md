...
### Llama-3-8B-Large (8B)
- **Syntax valid**: 72.0% (Benchmark 10: 71.3%, **+0.7 pp**)
- **Simulation pass**: 59.3% (Benchmark 10: 61.3%, **-2.0 pp**)
- **Avg generation time**: 4.71 s (Benchmark 10: 8.84 s, faster)
- **Avg iterations**: 1.15 (Benchmark 10: 1.14)
- **Avg entropy**: 0.024 (Benchmark 10: 0.023)
- **n_runs**: 150 (50 tasks × 3 reps)

### StarCoder2-7B-Medium
- **Syntax valid**: 59.3% (Benchmark 10: 58.7%, **+0.6 pp**)
- **Simulation pass**: 35.3% (Benchmark 10: 32.0%, **+3.3 pp**)
- **Avg generation time**: 1.95 s (Benchmark 10: 2.16 s, faster)
- **Avg iterations**: 1.15 (Benchmark 10: 1.09)
- **Avg entropy**: 0.086 (Benchmark 10: 0.209, markedly lower)
- **n_runs**: 150

### TinyLlama-1.1B-Small
- **Syntax valid**: 80.0% (Benchmark 10: 78.7%, **+1.3 pp**)
- **Simulation pass**: 60.7% (Benchmark 10: 52.7%, **+8.0 pp**)
- **Avg generation time**: 3.72 s (Benchmark 10: 4.33 s, faster)
- **Avg iterations**: 1.37 (Benchmark 10: 1.23)
...
|-------|--------------------|--------------------|-----------------------|-----------------------|-------|
| Llama-3-8B-Large | 71.3% | _TBD_ | 61.3% | _TBD_ | 50 tasks × 3 reps |
| StarCoder2-7B-Medium | 58.7% | _TBD_ | 32.0% | _TBD_ | 50 tasks × 3 reps |
| TinyLlama-1.1B-Small | 78.7% | _TBD_ | 52.7% | _TBD_ | 50 tasks × 3 reps |
